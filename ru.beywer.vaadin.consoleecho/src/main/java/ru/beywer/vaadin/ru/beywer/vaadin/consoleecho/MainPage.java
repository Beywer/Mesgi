...
//		замена стандартного System.out на StreamCapturer,
//		которому известна TextArea
		System.setOut(new PrintStream(capturer));
	}
 
//	переписан  OutputStream, который пишет в 
//	ранее стандартный System.out и в TextArea. 
...
//		Prefix был использован в подобном примере,
//		для вывода в интерфейс в виде [STDOUT] bububu
//		если не  нужен, убирается
        ...
        public void write(int b) throws IOException {
            ...
            buffer.append(value);
            if (value.equals("\n")) { //для печати префикса только на каждой новой строке
